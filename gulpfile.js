...
gulp.task('aos', function () {
    var stream = gulp.src(basePaths.node + 'aos/dist/aos.js')
        .pipe(gulp.dest('./js'));
    gulp.src(basePaths.node + 'aos/dist/aos.css')
        .pipe(gulp.dest('./css'));
    return stream;
});
...
var ini = gulp.parallel(['copy-assets', 'copyfonts', 'copypopper', 'animate', 'slick', 'wow', 'aos', 'simpleParallax',
